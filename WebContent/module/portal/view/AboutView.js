define([ 'backbone', 'util', 'i18n!../../../nls/translation' ], function(Backbone, util, i18n) {
	var AboutView = Backbone.View.extend({
		...
		render: function(){
			...
			$viewTitle.append('<h1>' + i18n.portal.AboutView.TITLE + '</h1>');
	        
			var $teamTitle = $('<div class="col-md-12 sub-title">');
			$teamTitle.append('<h2 class="line"> <span> <i class="fa fa-group"></i> ' + i18n.portal.AboutView.TEAM_TITLE + ' </span> </h2>');
			...
			$historyTitle.append('<h2 class="line"> <span> <i class="fa fa-history"></i> ' + i18n.portal.AboutView.HISTORY_TITLE + ' </span> </h2>');
			...
			$futureTitle.append('<h2 class="line"> <span> <i class="fa fa-paper-plane"></i> ' + i18n.portal.AboutView.FUTURE_TITLE + ' </span> </h2>');
